              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-amber-700 leading-relaxed">
                    ...
                    từ sừng truyền thống. Mỗi sản phẩm là một tác phẩm nghệ
                    thuật độc đáo, được tạo ra bởi đôi bàn tay khéo léo của nghệ
                    nhân lành nghề.
                  </p>
                </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="border-amber-200 hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-amber-700">
                    Sử dụng nguyên liệu sừng tự nhiên cao cấp, được tuyển chọn
                    kỹ lưỡng để đảm bảo chất lượng tốt nhất.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-amber-200 hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-amber-700">
                    Đội ngũ nghệ nhân có nhiều năm kinh nghiệm, thành thạo các
              ...
              <Card className="border-amber-200 hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-amber-700">
                    Mỗi sản phẩm đều mang tính nghệ thuật cao, kết hợp giữa
        ...
        <footer className="bg-amber-900 text-white py-12">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-4 gap-8">
              <div className="space-y-4">
                ...
                <p className="text-amber-200">
                  Chuyên chế tác các sản phẩm đồ sừng thủ công mỹ nghệ cao cấp
            ...
            <div className="border-t border-amber-800 mt-8 pt-8 text-center text-amber-200">
              <p>
                &copy; 2024 Sừng Thủ Công Mỹ Nghệ. Tất cả quyền được bảo lưu.
              </p>
            </div>
          </div>
        </footer>
