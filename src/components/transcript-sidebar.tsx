...
export function TranscriptSidebar() {
  ...
  return (
    <div className="w-96 border-l border-blue-200 flex flex-col bg-blue-50 h-full">
      <div className="p-4 border-b border-blue-200 flex-shrink-0">
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-2">
        {suggestedPrompts.map((item, index) => (
          <Card
            key={index}
            className="p-3 bg-white border-blue-200 hover:bg-blue-100 transition-colors cursor-pointer group"
